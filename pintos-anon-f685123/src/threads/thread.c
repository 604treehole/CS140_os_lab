...
unsigned fd_table_hash_function(const struct hash_elem *e, void *aux UNUSED);
                    ...
                    thread_func *function, void *aux)
{
  ...
  hash_init(&proc->fd_table, &fd_table_hash_function, &fd_table_less_func, NULL);
  proc->next_fd = 2;
  proc->parent_alive = true;
  proc->self_alive = true;
  proc->child_started = false;
...
unsigned
fd_table_hash_function(const struct hash_elem *e, void *aux UNUSED)
{
